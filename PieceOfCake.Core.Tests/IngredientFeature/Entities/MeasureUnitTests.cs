...
public class MeasureUnitTests : TestsBase
{
    ...
    {
        var measureUnit = await MeasureUnit.CreateAsync(measureUnitName, Resources, _uowMock.Object, CancellationToken.None);
    ...
    {
        var measureUnit = await MeasureUnit.CreateAsync(Fixture.CreateStringOfLength(Constants.FIFTY + 1), Resources, _uowMock.Object, CancellationToken.None);
        Assert.That(measureUnit.IsFailure);
    ...
    public async Task Create_Should_Return_User_Error_If_Name_Already_Exists ()
    {
        ...
        var measureUnitResult = await MeasureUnit.CreateAsync(alreadyExistingName, Resources, _uowMock.Object, CancellationToken.None);
        _measureUnitRepoMock
            .Setup(x => x.FirstOrDefaultAsync(It.IsAny<CancellationToken>(), It.IsAny<Expression<Func<MeasureUnit, bool>>>()))
            .ReturnsAsync(measureUnitResult.Value);

        //Act
        var result = await MeasureUnit.CreateAsync(alreadyExistingName, Resources, _uowMock.Object, CancellationToken.None);
    ...
    public async Task Create_Should_Succseed_If_Name_Meets_Requirenements ()
    {
        ...
        //Act
        var result = await MeasureUnit.CreateAsync(validName, Resources, _uowMock.Object, CancellationToken.None);
    ...
    public async Task Update_Should_Return_User_Error_If_Updated_Without_Name (string? measureUnitName)
    {
        ...
        var measureUnitResult = await MeasureUnit.CreateAsync(name, Resources, _uowMock.Object, CancellationToken.None);
        ...
        //Act
        var result = await measureUnit.UpdateAsync(measureUnitName, Resources, _uowMock.Object, CancellationToken.None);
    ...
    public async Task Update_Should_Return_User_Error_If_Name_Exceeds_Symbols_Count_Limit ()
    {
        //Arrange
        var name = Fixture.Create<string>();
        var measureUnit = await MeasureUnit.CreateAsync(name, Resources, _uowMock.Object, CancellationToken.None);
        _measureUnitRepoMock
            .Setup(x => x.FirstOrDefaultAsync(It.IsAny<CancellationToken>(), It.IsAny<Expression<Func<MeasureUnit, bool>>>()))
            .ReturnsAsync(measureUnit.Value);

        //Act
        var result = await measureUnit.Value.UpdateAsync(Fixture.CreateStringOfLength(Constants.FIFTY + 1), Resources, _uowMock.Object, CancellationToken.None);
    ...
    public async Task Update_Should_Return_User_Error_If_Name_Already_Exists ()
    {
        ...
        //Act
        var result = await measureUnit.Value.UpdateAsync(name, Resources, _uowMock.Object, CancellationToken.None);
